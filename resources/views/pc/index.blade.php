...
<head>
    ...
    <title>方寸堂 - 不止不同！中国宜兴紫砂壶品牌倡导者</title>
        ...
        <div class="yw-constr">
            <div class="yw-hd-slide-x">
                <div id="hdSlide1" class="yw-hd-slide-li yw-hd-slide-1 active"><s class="yw-hd-slide-bg"></s>
                    <div class="yw-hd-slide-con"><h2 class="yw-hd-slide-h">60＋发起人</h2>
                        <p class="yw-hd-slide-p">历经万千时间，<span class="hidden"><br></span>倾力打造寻觅东方紫砂的平台。</p></div>
                </div>
                <div id="hdSlide2" class="yw-hd-slide-li yw-hd-slide-2"><s class="yw-hd-slide-bg"></s>
                    <div class="yw-hd-slide-con">
                        <h2 class="yw-hd-slide-h">100＋手艺人</h2>
                        <p class="yw-hd-slide-p">磨砺紫砂技艺，<span class="hidden"><br></span>汇聚于此创作有魂有质的作品。</p>
                    </div>
                </div>
                <div id="hdSlide3" class="yw-hd-slide-li yw-hd-slide-3">
                    <s class="yw-hd-slide-bg"></s>
                    <div class="yw-hd-slide-con">
                        <h2 class="yw-hd-slide-h yw-font-helv">N＋寻觅人</h2>
                        <p class="yw-hd-slide-p">远离世间喧嚣，<span class="hidden"><br></span>在此相遇邂逅一触即爱的好物。</p>
                    </div>
                </div>
            </div>
        ...
        <div class="yw-constr">
            <div class="yw-data-view">
                <dl class="yw-data-dl yw-data-dl-1">
                    <dt class="yw-data-dt"><img src="{{ fct_cdn('/img/fct/constr_1.png') }}"><br>原创+限量</dt>
                    <dd class="yw-data-dd">100%原人手制，紫砂名家原创设计。作品限量发售，杜绝数量泛滥，我们对作品拥有原创著作权和商标认证。</dd>
                </dl>
                <dl class="yw-data-dl yw-data-dl-2">
                    <dt class="yw-data-dt"><img src="{{ fct_cdn('/img/fct/constr_2.png') }}"><br>标价+规范</dt>
                    <dd class="yw-data-dd">明码标价是我们敢于规范市场的第一步。所有首发单品不二价是我们对您做出的承诺。</dd>
                </dl>
                <dl class="yw-data-dl yw-data-dl-3">
                    <dt class="yw-data-dt"><img src="{{ fct_cdn('/img/fct/constr_3.png') }}"><br>保值+受益</dt>
                    <dd class="yw-data-dd">保值换购和增值回购两大政策，让您成为紫砂壶的受益者。销售只是起点，服务没有终点。</dd>
                </dl>
            </div>
            <p class="yw-data-desc">方寸堂，是一家由十多年从事紫砂艺术收藏的资深藏家组成的实力团队，公司设有紫砂研发中心、创作团队及新人培养基地，设立此平台的目的在于给天下壶友和紫砂艺人间搭建一个透明、便捷、真实的紫砂创作、交流平台。</p></div>
    </div>
    ...
    <div class="yw-footer">
        <div class="yw-constr">
            ...
            <div class="yw-footer-share">
                ...
                <a href="https://weibo.com/fangcuntang" class="icon-share icon-share-weibo" title="方寸堂官方微博" target="_blank">方寸堂官方微博</a>
            </div>
        </div>
    </div>
</div>
